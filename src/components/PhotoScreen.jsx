...
export default function PhotoScreen({ onNext }) {
    ...
    const photos = [
    { id: 1, src: "/images/k1.jpg" },
    { id: 2, src: "/images/k2.jpeg" },
    { id: 3, src: "/images/k3.png" },
        ...
        >
            ...
            >
                <h1 className="text-2xl md:text-3xl text-pink-200 leading-relaxed mb-4 font-semibold">
                    From the first day I met you, life became 🌙💗 <span className="text-pink-400 font-bold">Brighter and Easier to breath...</span>
                </h1>
                ...
                <motion.p
                    ...
                    transition={{ delay: 1 }}
                >
                    You've made every Day so Lighting 🕊️ 🌈
                </motion.p>
            </motion.div>
